...
namespace Vendor\ProductInquiry\Ui\Component\Listing\Columns;
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                $item[$fieldName . '_customerid'] = $item['inquiry_id'];
                $item[$fieldName . '_formaction'] = $this->urlBuilder->getUrl('productinquiry/inquiry/sendresponse');
            }
        }
        return $dataSource;
    }
